...
import com.adminsyndicate.HeadsHelper.Adapters.HeadsAdapter;
import com.adminsyndicate.HeadsHelper.Models.HeadsModel;
import com.adminsyndicate.LoginActivity;
        ...
        db.collection("Heads").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                for(DocumentSnapshot documentSnapshot:task.getResult()){
                    ...
                    headsModel.setPhone(documentSnapshot.getString("phoneNumber"));
